...
class MIDIParser::TypeConversionTest < Minitest::Test
  ...
  context 'TypeConversion' do
    ...
    context '.hex_chars_to_numeric_bytes' do
      ...
      setup do
        @nibbles = ['4', '5', '9', '3']
        @bytes = MIDIParser::TypeConversion.hex_chars_to_numeric_bytes(@nibbles)
      end
    ...
    context '.hex_str_to_hex_chars' do
      ...
      setup do
        @str = '904050'
        @nibbles = MIDIParser::TypeConversion.send(:hex_str_to_hex_chars, @str)
      end
    ...
    context '.hex_str_to_numeric_bytes' do
      ...
      setup do
        @str = '904050'
        @bytes = MIDIParser::TypeConversion.send(:hex_str_to_numeric_bytes, @str)
      end
    ...
    context '.numeric_bytes_to_numeric_nibbles' do
      ...
      setup do
        ...
        @nibbles = MIDIParser::TypeConversion.send(:numeric_bytes_to_numeric_nibbles, @bytes)
      end
    ...
    context '.hex_str_to_numeric_nibbles' do
      ...
      setup do
        @str = '904050'
        @nibbles = MIDIParser::TypeConversion.send(:hex_str_to_numeric_nibbles, @str)
      end
    ...
    context '.numeric_byte_to_numeric_nibbles' do
      ...
      setup do
        @num = 0x90
        @nibbles = MIDIParser::TypeConversion.send(:numeric_byte_to_numeric_nibbles, @num)
      end
    ...
    context '.numeric_byte_to_hex_chars' do
      ...
      setup do
        @num = 0x90
        @nibbles = MIDIParser::TypeConversion.send(:numeric_byte_to_hex_chars, @num)
      end
