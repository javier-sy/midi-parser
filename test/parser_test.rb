  ...
  context 'Parser' do
    ...
    context '#lookahead' do
      context 'basic' do
        setup do
          ...
          @output = @parser.send(:lookahead, fragment, MIDIParser::MessageBuilder.for_channel_message(0x9))
        end
    ...
    context '#process' do
      context 'basic' do
        ...
        should 'return proper message' do
          assert_equal(::MIDIEvents::NoteOn, @output.first.class)
        end
      ...
      context 'with running status' do
        ...
        should 'return proper message' do
          refute_nil @output
          assert_equal(::MIDIEvents::NoteOn, @output[0].class)
          assert_equal(::MIDIEvents::NoteOn, @output[1].class)
        end
